...
if __name__ == '__main__':
    ...
    save_net = r"X:\YOLO_V3\model\yolov3.weights"

    net.load_weights(save_net)

    # model.load_state_dict(torch.load(save_net , map_location=lambda storage, loc: storage))

    # net_dict = net.state_dict()
    # model_dict = model.state_dict()
    #
    # model_dict = {k: v for k, v in model_dict.items() if k in net_dict}
